...
<div class="page-wrapper">
    <div class="container cont-resDetail">
        <h1 class="txt-ask">Restoran Uhuy</h1>

        <div class="row">
            <div class="col-md-4">
                <img src="assets/images/restaurantDetail.png" alt="restaurant" width="100%">
            </div>
            <div class="col-md-8">
                ...
                <div class="row" style="font-size:24px">
                    ...
                    <p class="col-md-9">Restoran Uhuy</p>

                    <label class="col-md-3" style="color: #F88938">Category</label>
                    <p class="col-md-9">Fine Dining</p>

                    <label class="col-md-3" style="color: #F88938">Special Menu</label>
                    <p class="col-md-9">Lobster</p>

                    <label class="col-md-3" style="color: #F88938">Alamat</label>
                    <p class="col-md-9">Jl. In Ajadulu, no. 55, kec. Maknyus, Jakarta Selatan (Dekat indomaret) </p>
                </div>
